  ...
  return (
    <section id="hero">
      <div className="hero-text">
        ...
        <article>
          Hello! I’m Ghs Julian, a high-performance Full-Stack Web Developer
          based in Sylhet, Moulovibazar, Komolgonj, Madhabpur. With a track
          record of over 150+ successful projects on GitHub, I specialize in
          building scalable, secure, and futuristic web applications using the
          MERN stack, PHP, and Python. Whether you're looking for a robust
          e-commerce platform or a real-time custom engine, I turn complex
          requirements into seamless digital reality.
        </article>
      ...
      <div className="hero-img">
        {/*
                <img loading="lazy" id="hero-logo" src="/images/ghs-passport-photo-2.jpg" />
                */}
        {/*
                <img loading="lazy" id="hero-logo" src="/images/ghs-logo-hero.png" />
                */}

        <img loading="lazy" id="hero-logo" src="/images/ghs-hero2.png" />
      </div>
    </section>
  );
};
